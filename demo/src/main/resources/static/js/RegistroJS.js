...
/*
 * Condición de error para sexo var genero =
 * document.getElementById("radioButtonSexo"); var errorDeGene =
 * document.getElementById("errorSexo"); if(!genero.value == "h" || "m"){
 * errorDeGene.innerHTML = "Seleccione una opción.";
 * errorDeGene.style.color="red"; errores=true; }else{errorDeGene.innerHTML =
 * ""; }
 */
